...
export function InstructionsPage({ onContinue }: { onContinue: () => void }) {
  return (
    <PageShell>
      ...
      <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-7 text-center shadow-card sm:p-10">
        ...
        <p className="mx-auto mt-6 max-w-xl text-sm leading-relaxed text-slate-500">Não se preocupe em acertar ou errar. Queremos saber como você interpreta cada expressão.</p>
        <PrimaryButton fullWidth className="mt-8" onClick={onContinue}>Estou pronto</PrimaryButton>
      </section>
    </PageShell>
  );
}
